 ...
 * Description: WPCode-compatible REST bridge used by the Energize Website Builder to create Elementor V4 Atomic pages and manage site assets.
 * Version: 2.2.0
...
if (!defined('ENERGIZE_BUILD_TOOL_VERSION')) {
    define('ENERGIZE_BUILD_TOOL_VERSION', '2.2.0');
}
