  ...
  return (
    ...
    >
      <motion.button
        ...
        className={cn(
          "inline-flex size-5 shrink-0 items-center justify-center border-2 outline-none transition-colors duration-150",
          ...
          showMark
            ...
            : "border-[var(--color-black)] bg-white hover:bg-[var(--color-panel)]",
        )}
      >
